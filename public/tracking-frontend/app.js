...
let API_BASE_URL = window.location.origin.includes('localhost') 
    ? 'http://localhost:8000' 
    : 'https://siteotppythonbackendapi-production.up.railway.app';
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // Auto-refresh every 1.5 seconds for live messages checking
    autoRefreshInterval = setInterval(fetchTrackingData, 1500);
});
